...
sleep 3
  ui_print " "
  ui_print "- set in terminal : su (enter) xmod (enter)    "
sleep 0.5
  ui_print "- "
sleep 0.5
  ui_print "- no tweaks, the choice depends on your device and kernel "
sleep 0.5
  ui_print "- DWYOR, Do With Your Own Ris         "
sleep 1.5
  ui_print "- "
sleep 0.5
  ui_print "- Install Module Successfully !!!     "
sleep 2
  ui_print "- "
